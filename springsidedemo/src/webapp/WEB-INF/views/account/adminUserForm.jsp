	...
	<form id="inputForm" action="${ctx}/admin/user/update" method="post" class="form-horizontal">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="cnName" name="cnName" value="${user.cnName}" class="input-large required"/>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="userStatus" name="userStatus" value="${user.userStatus}" class="input-large required"/>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="roles" name="roles" value="${user.roles}" class="input-large required"/>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
				<textarea rows="2" cols="40" name="description" id="description" class="input-large required">${user.description}</textarea>
				</div>
			</div>
