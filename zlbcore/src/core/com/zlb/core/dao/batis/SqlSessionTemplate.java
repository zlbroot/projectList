...
public class SqlSessionTemplate implements SqlSession {
	...
	private class SqlSessionInterceptor implements InvocationHandler {
		public Object invoke(Object proxy, Method method, Object[] args)
				throws Throwable {
			SqlSession sqlSession = TransactionSynchronizationManager.getSqlSession(
					SqlSessionTemplate.this.sqlSessionFactory,
					SqlSessionTemplate.this.executorType,
					SqlSessionTemplate.this.exceptionTranslator);
			try {
				Object result = method.invoke(sqlSession, args);
				if (!TransactionSynchronizationManager.isSqlSessionTransactional(sqlSession,
						SqlSessionTemplate.this.sqlSessionFactory)) {
				...
				if (SqlSessionTemplate.this.exceptionTranslator != null
					...
					TransactionSynchronizationManager.closeSqlSession(sqlSession,
							SqlSessionTemplate.this.sqlSessionFactory);
					sqlSession = null;
